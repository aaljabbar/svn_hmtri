        ...
        jQuery("#grid-table").jqGrid({
            ...
            colModel: [
				{label: 'ID', name: 'bussinessunit_id', key: true, width: 5, sorttype: 'number', editable: true, hidden: true}, 
 				{label: 'Corporate Id',name: 'corporate_id' ,width: 100, align: 'right',editable: true,
  					  editoptions:{
   						     size: 30,
  						     maxlength:22
  					 },editrules: {required: false}
   				 }, 
 				{label: 'Butype Id',name: 'butype_id' ,width: 100, align: 'right',editable: true,
  					  editoptions:{
   						     size: 30,
  						     maxlength:22
  					 },editrules: {required: false}
