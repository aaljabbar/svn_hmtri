        ...
        jQuery("#grid-table").jqGrid({
            ...
            colModel: [
				{label: 'ID', name: 'allowancedet_id', key: true, width: 5, sorttype: 'number', editable: true, hidden: true}, 
 				{label: 'Allow Batch Id',name: 'allow_batch_id' ,width: 100, align: 'right',editable: true,
  					  editoptions:{
   						     size: 30,
  						     maxlength:22
 				...
 				{label: 'Allowancetrf Id',name: 'allowancetrf_id' ,width: 100, align: 'right',editable: true,
  					  editoptions:{
   						     size: 30,
  						     maxlength:22
  					 },editrules: {required: false}
