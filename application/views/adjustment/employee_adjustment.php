...
<script>
  ...
  $(function($) {
      $("#tab-2").on( "click", function() {
          ...
          loadContentWithParams("adjustment.adjustment", {
    ...
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            url: '<?php echo WS_JQGRID."adjustment.employee_adjustment_controller/crud"; ?>',
            datatype: "json",
            mtype: "POST",
            colModel: [
        ...
        {label: 'Perusahaan',name: 'bu_name' ,width: 100, align: 'left',editable: true,
            ...
            editurl: '<?php echo WS_JQGRID."adjustment.employee_adjustment_controller/crud"; ?>',
            caption: "Employee"
