...
<script type="text/javascript">
    function find(){
        ...
        jQuery(function($) {
            ...
            jQuery("#grid-table").jqGrid('setGridParam',{
                url: '<?php echo WS_JQGRID."payrollsummary.payrollsummary_controller/crud"; ?>',
    ...
    $.ajax({
        url: "<?php echo WS_JQGRID."payrollsummary.payrollsummary_controller/readDataComboYear"; ?>" ,
        type: "POST",
        dataType: "json",
        data: {},
    ...
    $.ajax({
        url: "<?php echo WS_JQGRID."payrollsummary.payrollsummary_controller/readDataComboPeriod"; ?>" ,
        type: "POST",
        dataType: "json",
        data: {},
        success: function (data) {
    ...
    function cetakPDF(payrollsummary_id){
        var p_finance_period_id = $('#p_finance_period_id').val();

        var url = "<?php echo base_url(); ?>"+"pdf_payroll_summary/save_pdf?p_finance_period_id="+p_finance_period_id+"&payrollsummary_id="+payrollsummary_id;
        openInNewTab(url);
    }    
...
<script>
    ...
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
                ...
                {label: 'Periode',name: 'periode' ,width: 100, align: 'left',editable: true,
                 ...
                 {name: 'Options',width: 100, align: "center",
                    formatter:function(cellvalue, options, rowObject) {
                        ...
                        return '<a class="btn btn-danger btn-xs" href="#" onclick="cetakPDF('+payrollsummary_id+');">PDF</a>';
                    }
                }
            ...
            editurl: '<?php echo WS_JQGRID."payrollsummary.payrollsummary_controller/crud"; ?>',
