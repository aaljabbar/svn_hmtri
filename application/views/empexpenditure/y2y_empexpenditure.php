    ...
    function find(){
        ...
        jQuery(function($) {
            ...
            jQuery("#grid-table").jqGrid('setGridParam',{
                url: '<?php echo WS_JQGRID."empexpenditure.y2y_empexpenditure_controller/crud"; ?>',
...
<script>
    ...
    $.ajax({
        url: "<?php echo WS_JQGRID."empexpenditure.y2y_empexpenditure_controller/readDataCombo"; ?>" ,
        type: "POST",
        dataType: "json",
        data: {},
    ...
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            ...
            editurl: '<?php echo WS_JQGRID."empexpenditure.y2y_empexpenditure_controller/crud"; ?>',
