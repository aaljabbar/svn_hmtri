...
<script>
    ...
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            url: '<?php echo WS_JQGRID."p_global_param.p_global_param_controller/crud"; ?>',
            datatype: "json",
            mtype: "POST",
            colModel: [
				{label: 'ID', name: 'p_global_param_id', key: true, width: 5, sorttype: 'number', editable: true, hidden: true}, 
                 ...
                 {label: 'Type 1',name: 'type_1' ,width: 100, align: 'left',editable: true,
                      editoptions:{
                             size: 30,
                             maxlength:32
                     },editrules: {required: false}
                 }, 
                 {label: 'Is Range',name: 'is_range' ,width: 100, align: 'left',editable: true,
                      editoptions:{
                             size: 30,
                             maxlength:1
                     },editrules: {required: false}
                 }, 
                 {label: 'Value 2',name: 'value_2' ,width: 100, align: 'left',editable: true,
                      editoptions:{
                             size: 30,
                             maxlength:128
                     },editrules: {required: false}
            ...
            editurl: '<?php echo WS_JQGRID."p_global_param.p_global_param_controller/crud"; ?>',
