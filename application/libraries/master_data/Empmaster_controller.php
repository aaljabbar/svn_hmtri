...
class Empmaster_controller {
    ...
    function crud() {
        ...
        switch ($oper) {
            case 'add' :
                permission_check('can-add-empmaster');
                $data = $this->create();
            break;

            case 'edit' :
                permission_check('can-edit-empmaster');
                $data = $this->update();
            break;

            case 'del' :
                permission_check('can-del-empmaster');
                $data = $this->destroy();
            break;

            default :
                permission_check('can-view-empmaster');
                $data = $this->read();
            break;
        }
